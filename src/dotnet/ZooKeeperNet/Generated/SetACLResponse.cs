...
{
    public class SetACLResponse : IRecord, System.IComparable
	{
		...
		public int CompareTo(object obj)
		{
			...
			int num = this.Stat.CompareTo(setACLResponse.Stat);
			if (num != 0)
			{
				return num;
			}
		...
		public override bool Equals(object obj)
		{
			...
			if (object.ReferenceEquals(setACLResponse, this))
			{
				return true;
			}
			bool flag = this.Stat.Equals(setACLResponse.Stat);
			if (!flag)
			{
				return flag;
			}
